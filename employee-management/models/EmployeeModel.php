...
class EmployeeModel {
    ...
    public function updateEmployee($id, $data) {
        $query = "UPDATE " . $this->table_name . " 
                  SET first_name = :first_name, last_name = :last_name, email = :email, department = :department, position = :position, salary = :salary, hire_date = :hire_date
                  WHERE id = :id";
    ...
    // METHOD 10: Get salary statistics per department
    ...
    // METHOD 12: Get employee overview
